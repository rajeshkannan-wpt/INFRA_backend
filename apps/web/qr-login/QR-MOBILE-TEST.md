...
6. Before scanning, verify the phone browser can open `http://<computer-LAN-IP>:3000/phone/link/test` (it should show the WPT link screen, even though the token is invalid).
